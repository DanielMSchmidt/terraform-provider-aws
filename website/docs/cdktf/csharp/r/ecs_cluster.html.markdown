...
class MyConvertedCode : TerraformStack
{
    ...
    {
        new EcsCluster.EcsCluster(this, "foo", new EcsClusterConfig {
            Name = "white-hart",
            Setting = new [] { new EcsClusterSetting {
...
class MyConvertedCode : TerraformStack
{
    public MyConvertedCode(Construct scope, string name) : base(scope, name)
    {
        var awsCloudwatchLogGroupExample =
        new CloudwatchLogGroup.CloudwatchLogGroup(this, "example", new CloudwatchLogGroupConfig {
            Name = "example"
        });
        var awsKmsKeyExample = new KmsKey.KmsKey(this, "example_1", new KmsKeyConfig {
            DeletionWindowInDays = 7,
            Description = "example"
        });
        /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
        awsKmsKeyExample.OverrideLogicalId("example");
        new EcsCluster.EcsCluster(this, "test", new EcsClusterConfig {
            Configuration = new EcsClusterConfiguration {
                ExecuteCommandConfiguration = new EcsClusterConfigurationExecuteCommandConfiguration {
                    ...
                    LogConfiguration = new EcsClusterConfigurationExecuteCommandConfigurationLogConfiguration {
                        ...
                        CloudWatchLogGroupName = Token.AsString(awsCloudwatchLogGroupExample.Name)
                    },
                    Logging = "OVERRIDE"
                }
            },

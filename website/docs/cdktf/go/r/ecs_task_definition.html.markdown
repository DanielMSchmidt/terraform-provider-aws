...
import "github.com/aws-samples/dummy/gen/providers/aws/ecsTaskDefinition"
...
func newMyConvertedCode(scope construct, name *string) *myConvertedCode {
	...
	ecsTaskDefinition.NewEcsTaskDefinition(this, jsii.String("service"), &ecsTaskDefinitionConfig{
		containerDefinitions: cdktf.Fn_Jsonencode([]interface{}{
			map[string]interface{}{
				"cpu": jsii.Number(10),
				"essential": jsii.Boolean(true),
				"image": jsii.String("service-first"),
				"memory": jsii.Number(512),
				"name": jsii.String("first"),
				"portMappings": []map[string]*f64{
					map[string]*f64{
			...
			map[string]interface{}{
				"cpu": jsii.Number(10),
				"essential": jsii.Boolean(true),
				"image": jsii.String("service-second"),
				"memory": jsii.Number(256),
				"name": jsii.String("second"),
				"portMappings": []map[string]*f64{
					map[string]*f64{
		...
		placementConstraints: []interface{}{
			&ecsTaskDefinitionPlacementConstraints{
				expression: jsii.String("attribute:ecs.availability-zone in [us-west-2a, us-west-2b]"),
				type: jsii.String("memberOf"),
			},
		},
		volume: []interface{}{
			&ecsTaskDefinitionVolume{
				hostPath: jsii.String("/ecs/service-storage"),
				name: jsii.String("service-storage"),
			},
		},
	})
	return this
...
func newMyConvertedCode(scope construct, name *string) *myConvertedCode {
	this := &myConvertedCode{}
	cdktf.NewTerraformStack_Override(this, scope, name)
	ecsTaskDefinition.NewEcsTaskDefinition(this, jsii.String("test"), &ecsTaskDefinitionConfig{
		...
		inferenceAccelerator: []interface{}{
			&ecsTaskDefinitionInferenceAccelerator{
				deviceName: jsii.String("device_1"),
				deviceType: jsii.String("eia1.medium"),
			},
		},
	})
	return this
...
func newMyConvertedCode(scope construct, name *string) *myConvertedCode {
	...
	ecsTaskDefinition.NewEcsTaskDefinition(this, jsii.String("test"), &ecsTaskDefinitionConfig{
		...
		cpu: cdktf.Token_AsString(jsii.Number(1024)),
		family: jsii.String("test"),
		memory: cdktf.Token_*AsString(jsii.Number(2048)),
		networkMode: jsii.String("awsvpc"),
		requiresCompatibilities: []*string{
			jsii.String("FARGATE"),
		},
		runtimePlatform: &ecsTaskDefinitionRuntimePlatform{
			cpuArchitecture: jsii.String("X86_64"),
			operatingSystemFamily: jsii.String("WINDOWS_SERVER_2019_CORE"),
		},
	})
	return this
}
...
<!-- cache-key: cdktf-0.17.0-pre.9 input-753bf453930308324b1281cef46f05e3281f06226fea9d6da61aa1c342749b0e -->
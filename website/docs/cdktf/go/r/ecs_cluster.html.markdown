...
import "github.com/aws-samples/dummy/gen/providers/aws/ecsCluster"
...
func newMyConvertedCode(scope construct, name *string) *myConvertedCode {
	...
	ecsCluster.NewEcsCluster(this, jsii.String("foo"), &ecsClusterConfig{
		name: jsii.String("white-hart"),
		setting: []interface{}{
			&ecsClusterSetting{
...
/*Provider bindings are generated by running cdktf get.
See https://cdk.tf/provider-generation for more details.*/
import "github.com/aws-samples/dummy/gen/providers/aws/cloudwatchLogGroup"
...
func newMyConvertedCode(scope construct, name *string) *myConvertedCode {
	this := &myConvertedCode{}
	cdktf.NewTerraformStack_Override(this, scope, name)
	awsCloudwatchLogGroupExample :=
	cloudwatchLogGroup.NewCloudwatchLogGroup(this, jsii.String("example"), &cloudwatchLogGroupConfig{
		name: jsii.String("example"),
	})
	awsKmsKeyExample := kmsKey.NewKmsKey(this, jsii.String("example_1"), &kmsKeyConfig{
		deletionWindowInDays: jsii.Number(7),
		description: jsii.String("example"),
	})
	/*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
	awsKmsKeyExample.OverrideLogicalId(jsii.String("example"))
	ecsCluster.NewEcsCluster(this, jsii.String("test"), &ecsClusterConfig{
		configuration: &ecsClusterConfiguration{
			executeCommandConfiguration: &ecsClusterConfigurationExecuteCommandConfiguration{
				kmsKeyId: cdktf.Token_AsString(awsKmsKeyExample.arn),
				logConfiguration: &ecsClusterConfigurationExecuteCommandConfigurationLogConfiguration{
					...
					cloudWatchLogGroupName: cdktf.Token_*AsString(awsCloudwatchLogGroupExample.name),
				},
				logging: jsii.String("OVERRIDE"),
			},
		},
		name: jsii.String("example"),
	})
...
<!-- cache-key: cdktf-0.17.0-pre.9 input-caeaae81c5f4b27f2329ac4a80a1d178b87649940666d2173fcdc995ee5fcb9b -->
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        cdktf.TerraformOutput(self, "vpc_all_tags",
            value=aws_vpc_example.tags_all
        )
        cdktf.TerraformOutput(self, "vpc_resource_level_tags",
            value=aws_vpc_example.tags
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-4fb6331211ecf49417672ecaa3c427cdd96945fbe6c638849928e4cd137e30ab -->
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.iam_server_certificate.IamServerCertificate(self, "test_cert_alt",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bb4a92f0540a366c4aa69552cf518bcc94301f78aa45577b709f4ab8dc528daa -->
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_sagemaker_prebuilt_ecr_image_test =
        ...
        aws_sagemaker_model_example = aws.sagemaker_model.SagemakerModel(self, "example_3",
            execution_role_arn=cdktf.Token.as_string(aws_iam_role_example.arn),
            name="my-model",
            primary_container=SagemakerModelPrimaryContainer(
                image=cdktf.Token.as_string(data_aws_sagemaker_prebuilt_ecr_image_test.registry_path)
            )
        )

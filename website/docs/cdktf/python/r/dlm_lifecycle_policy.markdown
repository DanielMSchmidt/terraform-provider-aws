...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_iam_policy_document_dlm_lifecycle =
        aws.data_aws_iam_policy_document.DataAwsIamPolicyDocument(self, "dlm_lifecycle",
            statement=[DataAwsIamPolicyDocumentStatement(
        ...
        aws_iam_role_dlm_lifecycle_role = aws.iam_role.IamRole(self, "dlm_lifecycle_role",
            assume_role_policy=cdktf.Token.as_string(data_aws_iam_policy_document_assume_role.json),
            name="dlm-lifecycle-role"
        )
        aws_iam_role_policy_dlm_lifecycle = aws.iam_role_policy.IamRolePolicy(self, "dlm_lifecycle_3",
            name="dlm-lifecycle-policy",
            policy=cdktf.Token.as_string(data_aws_iam_policy_document_dlm_lifecycle.json),
            role=cdktf.Token.as_string(aws_iam_role_dlm_lifecycle_role.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_iam_role_policy_dlm_lifecycle.override_logical_id("dlm_lifecycle")
        aws.dlm_lifecycle_policy.DlmLifecyclePolicy(self, "example",
            description="example DLM lifecycle policy",
            execution_role_arn=cdktf.Token.as_string(aws_iam_role_dlm_lifecycle_role.arn),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-ddf914336ebc8f4e4800898916b39547121fe0300c5c3511ce6f9146695ab474 -->
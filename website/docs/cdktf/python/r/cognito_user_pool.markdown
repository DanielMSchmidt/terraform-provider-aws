...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.cognito_user_pool.CognitoUserPool(self, "pool",
            name="mypool"
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws.cognito_user_pool.CognitoUserPool(self, "test",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-fbb9cba0a3b908eba977aae25d48c5630ebdbb034d728f735ff6fb33a39581a8 -->
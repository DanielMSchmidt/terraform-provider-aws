...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_wafregional_rule_wafrule = aws.wafregional_rule.WafregionalRule(self, "wafrule",
        ...
        aws.wafregional_web_acl.WafregionalWebAcl(self, "wafacl",
            ...
            rule=[WafregionalWebAclRule(
                ...
                priority=1,
                rule_id=cdktf.Token.as_string(aws_wafregional_rule_wafrule.id),
                type="REGULAR"
            )
            ]
        )

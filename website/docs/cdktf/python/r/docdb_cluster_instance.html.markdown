...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_docdb_cluster_default = aws.docdb_cluster.DocdbCluster(self, "default",
        ...
        aws_docdb_cluster_instance_cluster_instances_count =
        cdktf.TerraformCount.of(cdktf.Token.as_number("2"))
        aws.docdb_cluster_instance.DocdbClusterInstance(self, "cluster_instances",
            cluster_identifier=cdktf.Token.as_string(aws_docdb_cluster_default.id),
            identifier="docdb-cluster-demo-${" + aws_docdb_cluster_instance_cluster_instances_count.index + "}",
            instance_class="db.r5.large",
            count=aws_docdb_cluster_instance_cluster_instances_count
        )
```

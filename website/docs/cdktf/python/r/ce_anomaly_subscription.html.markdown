...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_ce_anomaly_monitor_test = aws.ce_anomaly_monitor.CeAnomalyMonitor(self, "test",
            monitor_dimension="SERVICE",
            monitor_type="DIMENSIONAL",
            name="AWSServiceMonitor"
        )
        aws_ce_anomaly_subscription_test =
        aws.ce_anomaly_subscription.CeAnomalySubscription(self, "test_1",
            frequency="DAILY",
            monitor_arn_list=[cdktf.Token.as_string(aws_ce_anomaly_monitor_test.arn)],

...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.vpn_connection.VpnConnection(self, "main",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws_customer_gateway_example = aws.customer_gateway.CustomerGateway(self, "example",
            bgp_asn=cdktf.Token.as_string(64514),
            ip_address="10.0.0.1",
            tags={
        ...
        aws_dx_gateway_example = aws.dx_gateway.DxGateway(self, "example_1",
        ...
        aws_ec2_transit_gateway_example =
        aws.ec2_transit_gateway.Ec2TransitGateway(self, "example_2",
            amazon_side_asn=cdktf.Token.as_number("64513"),
        ...
        aws.data_aws_ec2_transit_gateway_dx_gateway_attachment.DataAwsEc2TransitGatewayDxGatewayAttachment(self, "example_4",
        ...
        aws_vpn_connection_example = aws.vpn_connection.VpnConnection(self, "example_5",
            customer_gateway_id=cdktf.Token.as_string(aws_customer_gateway_example.id),
            ...
            transit_gateway_id=cdktf.Token.as_string(aws_ec2_transit_gateway_example.id),
            transport_transit_gateway_attachment_id=cdktf.Token.as_string(data_aws_ec2_transit_gateway_dx_gateway_attachment_example.id),
            type="ipsec.1"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_vpn_connection_example.override_logical_id("example")
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-4a7549d2ff1d2d87d386cd9572d69b07fe98cc30eb1e627064368f40b0733b79 -->
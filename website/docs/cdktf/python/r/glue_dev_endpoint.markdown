...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_iam_role_example = aws.iam_role.IamRole(self, "example_1",
        ...
        aws.iam_role_policy_attachment.IamRolePolicyAttachment(self, "example-AWSGlueServiceRole",
            policy_arn="arn:aws:iam::aws:policy/service-role/AWSGlueServiceRole",
            role=cdktf.Token.as_string(aws_iam_role_example.name)
        )
        aws_glue_dev_endpoint_example = aws.glue_dev_endpoint.GlueDevEndpoint(self, "example_3",
            name="foo",

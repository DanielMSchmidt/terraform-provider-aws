...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_prefix_list_s3 = aws.data_aws_prefix_list.DataAwsPrefixList(self, "s3",
            name="com.amazonaws.${" + data_aws_region_current.name + "}.s3"
        )
        aws.security_group_rule.SecurityGroupRule(self, "s3_gateway_egress",
            description="S3 Gateway Egress",
            from_port=443,
            prefix_list_ids=[cdktf.Token.as_string(data_aws_prefix_list_s3.id)],
            protocol="tcp",
            security_group_id="sg-123456",
            to_port=443,
            type="egress"

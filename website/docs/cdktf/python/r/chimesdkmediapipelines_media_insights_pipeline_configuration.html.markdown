...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_iam_policy_document_media_pipelines_assume_role =
        aws.data_aws_iam_policy_document.DataAwsIamPolicyDocument(self, "media_pipelines_assume_role",
        ...
        aws_iam_role_call_analytics_role = aws.iam_role.IamRole(self, "call_analytics_role",
            assume_role_policy=cdktf.Token.as_string(data_aws_iam_policy_document_media_pipelines_assume_role.json),
            name="CallAnalyticsRole"
        )
        aws.chimesdkmediapipelines_media_insights_pipeline_configuration.ChimesdkmediapipelinesMediaInsightsPipelineConfiguration(self, "my_configuration",
            ...
            resource_access_role_arn=cdktf.Token.as_string(aws_iam_role_call_analytics_role.arn),
            tags={
                "Key1": "Value1",
                "Key2": "Value2"
            }

...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.elasticache_replication_group.ElasticacheReplicationGroup(self, "example",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws_elasticache_replication_group_example =
        aws.elasticache_replication_group.ElasticacheReplicationGroup(self, "example",
            automatic_failover_enabled=True,
            description="example description",
        ...
        aws_elasticache_cluster_replica_count = cdktf.TerraformCount.of(
            cdktf.Token.as_number("1"))
        aws.elasticache_cluster.ElasticacheCluster(self, "replica",
            cluster_id="tf-rep-group-1-${" + aws_elasticache_cluster_replica_count.index + "}",
            replication_group_id=cdktf.Token.as_string(aws_elasticache_replication_group_example.id),
            count=aws_elasticache_cluster_replica_count
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws.elasticache_replication_group.ElasticacheReplicationGroup(self, "baz",
            automatic_failover_enabled=True,
            description="example description",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a754c29259611e28b68a8c13137ea392259b10359f973b1671b5dfd375f20ddd -->
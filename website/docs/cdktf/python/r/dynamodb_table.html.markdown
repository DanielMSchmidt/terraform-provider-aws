...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.dynamodb_table.DynamodbTable(self, "basic-dynamodb-table",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws.dynamodb_table.DynamodbTable(self, "example",
            attribute=[DynamodbTableAttribute(
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-dca692e48d9f7ea2fb22153959cd59fba0b1213f5690b8b540a2118e30a91eb1 -->
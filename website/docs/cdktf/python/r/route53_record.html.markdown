...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_route53_record_example = aws.route53_record.Route53Record(self, "example_1",
            allow_overwrite=True,
            name="test.example.com",
            records=[
                cdktf.Token.as_string(
                    cdktf.property_access(aws_route53_zone_example.name_servers, ["0"])),
                cdktf.Token.as_string(
                    cdktf.property_access(aws_route53_zone_example.name_servers, ["1"])),
                cdktf.Token.as_string(
                    cdktf.property_access(aws_route53_zone_example.name_servers, ["2"])),
                cdktf.Token.as_string(
                    cdktf.property_access(aws_route53_zone_example.name_servers, ["3"]))
            ],
            ttl=172800,
            type="NS",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-4cb59f8ae6886062f415c397b0fd3b8a1c317e0b2165196eb560cdfae1da69da -->
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_rds_reserved_instance_offering_test =
        ...
        aws.rds_reserved_instance.RdsReservedInstance(self, "example",
            instance_count=3,
            offering_id=cdktf.Token.as_string(data_aws_rds_reserved_instance_offering_test.offering_id),

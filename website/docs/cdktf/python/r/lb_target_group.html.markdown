...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.lb_target_group.LbTargetGroup(self, "test",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.lb_target_group.LbTargetGroup(self, "ip-example",
            name="tf-example-lb-tg",
            port=80,
            protocol="HTTP",
            target_type="ip",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws.lb_target_group.LbTargetGroup(self, "lambda-example",
            name="tf-example-lb-tg",
            target_type="lambda"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5d7cbc4b6e3a5882343bb3cc9f8167c0bc647207a6500d9c7cf4fa9b63619152 -->
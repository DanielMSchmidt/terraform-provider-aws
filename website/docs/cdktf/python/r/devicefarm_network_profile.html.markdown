...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_devicefarm_project_example =
        aws.devicefarm_project.DevicefarmProject(self, "example",
            name="example"
        )
        aws_devicefarm_network_profile_example =
        aws.devicefarm_network_profile.DevicefarmNetworkProfile(self, "example_1",
            name="example",
            project_arn=cdktf.Token.as_string(aws_devicefarm_project_example.arn)
        )

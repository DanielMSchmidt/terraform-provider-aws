...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_cloudwatch_event_rule_stop_instances =
        aws.cloudwatch_event_rule.CloudwatchEventRule(self, "stop_instances",
            description="Stop instances nightly",
            name="StopInstance",
            schedule_expression="cron(0 0 * * ? *)"
        )
        aws_ssm_document_stop_instance = aws.ssm_document.SsmDocument(self, "stop_instance",
        ...
        data_aws_iam_policy_document_ssm_lifecycle =
        aws.data_aws_iam_policy_document.DataAwsIamPolicyDocument(self, "ssm_lifecycle",
            statement=[DataAwsIamPolicyDocumentStatement(
                ...
                actions=["ssm:SendCommand"],
                effect="Allow",
                resources=[cdktf.Token.as_string(aws_ssm_document_stop_instance.arn)]
            )
            ]
        )
        data_aws_iam_policy_document_ssm_lifecycle_trust =
        aws.data_aws_iam_policy_document.DataAwsIamPolicyDocument(self, "ssm_lifecycle_trust",
            statement=[DataAwsIamPolicyDocumentStatement(
        ...
        aws_iam_policy_ssm_lifecycle = aws.iam_policy.IamPolicy(self, "ssm_lifecycle_4",
            name="SSMLifecycle",
            policy=cdktf.Token.as_string(data_aws_iam_policy_document_ssm_lifecycle.json)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_iam_policy_ssm_lifecycle.override_logical_id("ssm_lifecycle")
        aws_iam_role_ssm_lifecycle = aws.iam_role.IamRole(self, "ssm_lifecycle_5",
            assume_role_policy=cdktf.Token.as_string(data_aws_iam_policy_document_ssm_lifecycle_trust.json),
            name="SSMLifecycle"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_iam_role_ssm_lifecycle.override_logical_id("ssm_lifecycle")
        aws_iam_role_policy_attachment_ssm_lifecycle =
        aws.iam_role_policy_attachment.IamRolePolicyAttachment(self, "ssm_lifecycle_6",
            policy_arn=cdktf.Token.as_string(aws_iam_policy_ssm_lifecycle.arn),
            role=cdktf.Token.as_string(aws_iam_role_ssm_lifecycle.name)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_iam_role_policy_attachment_ssm_lifecycle.override_logical_id("ssm_lifecycle")
        aws_cloudwatch_event_target_stop_instances =
        aws.cloudwatch_event_target.CloudwatchEventTarget(self, "stop_instances_7",
            arn=cdktf.Token.as_string(aws_ssm_document_stop_instance.arn),
            role_arn=cdktf.Token.as_string(aws_iam_role_ssm_lifecycle.arn),
            rule=cdktf.Token.as_string(aws_cloudwatch_event_rule_stop_instances.name),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws_cloudwatch_event_rule_example =
        aws.cloudwatch_event_rule.CloudwatchEventRule(self, "example",
        ...
        aws.cloudwatch_log_group.CloudwatchLogGroup(self, "example_1",
            name="/aws/events/guardduty/logs",
            retention_in_days=1
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_cloudwatch_log_group_example.override_logical_id("example")
        data_aws_iam_policy_document_example_log_policy =
        aws.data_aws_iam_policy_document.DataAwsIamPolicyDocument(self, "example_log_policy",
            statement=[DataAwsIamPolicyDocumentStatement(
                ...
                condition=[DataAwsIamPolicyDocumentStatementCondition(
                    test="ArnEquals",
                    values=[
                        cdktf.Token.as_string(aws_cloudwatch_event_rule_example.arn)
                    ],
        ...
        aws_cloudwatch_event_target_example =
        aws.cloudwatch_event_target.CloudwatchEventTarget(self, "example_3",
            arn=cdktf.Token.as_string(aws_cloudwatch_log_group_example.arn),
            rule=cdktf.Token.as_string(aws_cloudwatch_event_rule_example.name)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        aws_cloudwatch_event_target_example.override_logical_id("example")
        aws_cloudwatch_log_resource_policy_example =
        aws.cloudwatch_log_resource_policy.CloudwatchLogResourcePolicy(self, "example_4",
            policy_document=cdktf.Token.as_string(data_aws_iam_policy_document_example_log_policy.json),

...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_rds_cluster_instance_cluster_instances_count = cdktf.TerraformCount.of(
            cdktf.Token.as_number("2"))
        aws.rds_cluster_instance.RdsClusterInstance(self, "cluster_instances",
            ...
            identifier="aurora-cluster-demo-${" + aws_rds_cluster_instance_cluster_instances_count.index + "}",
            instance_class="db.r4.large",
            count=aws_rds_cluster_instance_cluster_instances_count
        )
```

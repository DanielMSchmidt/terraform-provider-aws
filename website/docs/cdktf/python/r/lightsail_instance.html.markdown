...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.lightsail_instance.LightsailInstance(self, "gitlab_test",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws.lightsail_instance.LightsailInstance(self, "custom",
            availability_zone="us-east-1b",
            blueprint_id="amazon_linux_2",
            bundle_id="nano_1_0",
            name="custom",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-8794e5c039b4cd86d914f10e5ffc739f48a1cd217b38657b29ef0c21e0c182d5 -->
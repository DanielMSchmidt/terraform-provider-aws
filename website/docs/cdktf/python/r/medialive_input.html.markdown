...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_medialive_input_security_group_example =
        ...
        aws_medialive_input_example = aws.medialive_input.MedialiveInput(self, "example_1",
            input_security_groups=[
                cdktf.Token.as_string(aws_medialive_input_security_group_example.id)
            ],
            name="example-input",
            tags={
                "ENVIRONMENT": "prod"

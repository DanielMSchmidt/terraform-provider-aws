...
import ...gen.providers.archive as archive
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_archive_file_lambda = archive.data_archive_file.DataArchiveFile(self, "lambda",
        ...
        aws.lambda_function.LambdaFunction(self, "test_lambda",
            ...
            runtime="nodejs16.x",
            source_code_hash=cdktf.Token.as_string(data_archive_file_lambda.output_base64_sha256)
        )
```

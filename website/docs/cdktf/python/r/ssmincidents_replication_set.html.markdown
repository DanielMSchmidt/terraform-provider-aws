...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.ssmincidents_replication_set.SsmincidentsReplicationSet(self, "replicationSetName",
            region=[SsmincidentsReplicationSetRegion(
                name="us-west-2"
            )
            ],
            tags={
                "example_tag": "exampleValue"
            }
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws_kms_key_example_key = aws.kms_key.KmsKey(self, "example_key")
        aws.ssmincidents_replication_set.SsmincidentsReplicationSet(self, "replicationSetName",
            region=[SsmincidentsReplicationSetRegion(
                kms_key_arn=cdktf.Token.as_string(aws_kms_key_example_key.arn),
                name="us-west-2"
            )
            ],
            tags={

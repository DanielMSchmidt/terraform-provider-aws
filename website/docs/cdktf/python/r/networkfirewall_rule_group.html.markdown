...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.networkfirewall_rule_group.NetworkfirewallRuleGroup(self, "example",
            capacity=100,
            name="example",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_networkfirewall_rule_group_example_dynamic_iterator0 =
        cdktf.TerraformIterator.from_list(cdktf.Token.as_any(ips))
        aws.networkfirewall_rule_group.NetworkfirewallRuleGroup(self, "example",
            capacity=50,
            ...
            rule_group=NetworkfirewallRuleGroupRuleGroup(
                rules_source=NetworkfirewallRuleGroupRuleGroupRulesSource(
                    stateful_rule=
                    aws_networkfirewall_rule_group_example_dynamic_iterator0.dynamic({
                        "action": "PASS",
                        "header": [{
                            "destination": "ANY",
                            ...
                            "direction": "ANY",
                            "protocol": "HTTP",
                            "source": aws_networkfirewall_rule_group_example_dynamic_iterator0.value,
                            "source_port": "ANY"
                        }
                        ],
                        "rule_option": [{
                ...
                rules_source=NetworkfirewallRuleGroupRuleGroupRulesSource(
                    stateful_rule=[NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRule(
                        ...
                        header=NetworkfirewallRuleGroupRuleGroupRulesSourceStatefulRuleHeader(
                            ...
                            destination_port=cdktf.Token.as_string(53),
                            direction="ANY",
                            protocol="TCP",
                            source="1.2.3.4/32",
                            source_port=cdktf.Token.as_string(53)
                        ),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-64326de68d2e2412445331e957a7ed713781e3d88821217a024759d73ccd87c8 -->
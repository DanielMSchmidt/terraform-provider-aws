...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_s3_bucket_object_example = aws.s3_bucket_object.S3BucketObject(self, "example_3",
            bucket=cdktf.Token.as_string(aws_s3_bucket_examplebucket.id),
            key="someobject",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_s3_bucket_object_example = aws.s3_bucket_object.S3BucketObject(self, "example_2",
            bucket=cdktf.Token.as_string(aws_s3_bucket_examplebucket.id),
            key="someobject",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c22e4ca0f52d3a6001a5ba85b4f2b12464c1eea33334f7c8143f88a94cd2a822 -->
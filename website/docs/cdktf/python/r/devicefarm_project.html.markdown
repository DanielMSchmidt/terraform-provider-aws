...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.devicefarm_project.DevicefarmProject(self, "awesome_devices",
            name="my-device-farm"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-51e489a51c7e876bed0ef3b142eea0067dd93e8e0669e16cd238e40262d6a741 -->
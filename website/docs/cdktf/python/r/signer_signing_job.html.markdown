...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_signer_signing_profile_test_sp =
        aws.signer_signing_profile.SignerSigningProfile(self, "test_sp",
            platform_id="AWSLambda-SHA384-ECDSA"
        )
        aws.signer_signing_job.SignerSigningJob(self, "build_signing_job",
            ...
            profile_name=cdktf.Token.as_string(aws_signer_signing_profile_test_sp.name),

...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_iam_session_context_current =
        aws.data_aws_iam_session_context.DataAwsIamSessionContext(self, "current_1",
        ...
        aws.lakeformation_data_lake_settings.LakeformationDataLakeSettings(self, "test",
            admins=[
                cdktf.Token.as_string(data_aws_iam_session_context_current.issuer_arn)
            ]
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-80270f9881a006fb9a17532d409cacf39fc8d96aaa65b19803c52686360700de -->
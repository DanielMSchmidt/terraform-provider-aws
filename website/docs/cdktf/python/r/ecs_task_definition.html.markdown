...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.ecs_task_definition.EcsTaskDefinition(self, "service",
            container_definitions=cdktf.Fn.jsonencode([{
                "cpu": 10,
                "essential": True,
                "image": "service-first",
                "memory": 512,
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws.ecs_task_definition.EcsTaskDefinition(self, "test",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.ecs_task_definition.EcsTaskDefinition(self, "test",
            ...
            cpu=cdktf.Token.as_string(1024),
            family="test",
            memory=cdktf.Token.as_string(2048),
            network_mode="awsvpc",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-753bf453930308324b1281cef46f05e3281f06226fea9d6da61aa1c342749b0e -->
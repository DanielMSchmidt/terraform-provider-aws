...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.launch_configuration.LaunchConfiguration(self, "as_conf",
            image_id=cdktf.Token.as_string(data_aws_ami_ubuntu.id),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_launch_configuration_as_conf =
        aws.launch_configuration.LaunchConfiguration(self, "as_conf",
            image_id=cdktf.Token.as_string(data_aws_ami_ubuntu.id),
            instance_type="t2.micro",
        ...
        aws.autoscaling_group.AutoscalingGroup(self, "bar",
            launch_configuration=cdktf.Token.as_string(aws_launch_configuration_as_conf.name),
            lifecycle=cdktf.TerraformResourceLifecycle(
                create_before_destroy=True
            ),
            max_size=2,

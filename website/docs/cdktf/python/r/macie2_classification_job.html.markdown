...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_macie2_account_test = aws.macie2_account.Macie2Account(self, "test")
        aws_macie2_classification_job_test =
        aws.macie2_classification_job.Macie2ClassificationJob(self, "test_1",

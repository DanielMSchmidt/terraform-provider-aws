...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_vpc_mainvpc = aws.vpc.Vpc(self, "mainvpc",
            cidr_block="10.1.0.0/16"
        )
        aws.default_network_acl.DefaultNetworkAcl(self, "default",
            default_network_acl_id=cdktf.Token.as_string(aws_vpc_mainvpc.default_network_acl_id),
            egress=[DefaultNetworkAclEgress(
                action="allow",
                cidr_block="0.0.0.0/0",
                from_port=0,
                protocol=cdktf.Token.as_string(cdktf.Op.negate(1)),
                rule_no=100,
                to_port=0
            )
            ],
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d173f387eae0b569874e7ed04da66df3b1e3f91683a0af401a2870eb41e41174 -->
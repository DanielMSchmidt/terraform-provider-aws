...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.servicecatalog_provisioned_product.ServicecatalogProvisionedProduct(self, "example",
            name="example",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e41128ed97ad2c3d3ddcd05d233bb0d5f52e6d020ca6b7e4c9f3ac417632692a -->
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.dx_public_virtual_interface.DxPublicVirtualInterface(self, "foo",
            address_family="ipv4",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0b41c1e48569b1aced031602b3be9360677e8f923e53b9cdbdbb8fe896f3e5e3 -->
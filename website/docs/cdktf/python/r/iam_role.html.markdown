...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.iam_role.IamRole(self, "test_role",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        data_aws_iam_policy_document_instance_assume_role_policy =
        aws.data_aws_iam_policy_document.DataAwsIamPolicyDocument(self, "instance_assume_role_policy",
        ...
        aws.iam_role.IamRole(self, "instance",
            assume_role_policy=cdktf.Token.as_string(data_aws_iam_policy_document_instance_assume_role_policy.json),
            name="instance_role",
            path="/system/"
        )
```

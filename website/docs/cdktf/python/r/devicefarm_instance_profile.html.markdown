...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.devicefarm_instance_profile.DevicefarmInstanceProfile(self, "example",
            name="example"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-993bc13ded1af85457d881feb076d45383675346570f750d66366aefe8112075 -->
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.iam_instance_profile.IamInstanceProfile(self, "test_profile",
            name="test_profile",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0b88b5dcd99e7e3fc35effa19d62df49008923f154e81cb9b1dc749639c1b679 -->
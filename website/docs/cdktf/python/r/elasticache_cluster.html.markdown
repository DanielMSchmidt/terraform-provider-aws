...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.elasticache_cluster.ElasticacheCluster(self, "example",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_outposts_outposts_example =
        aws.data_aws_outposts_outposts.DataAwsOutpostsOutposts(self, "example_1")
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_aws_outposts_outposts_example.override_logical_id("example")
        aws_subnet_example = aws.subnet.Subnet(self, "example_2",
        ...
        data_aws_outposts_outpost_example =
        aws.data_aws_outposts_outpost.DataAwsOutpostsOutpost(self, "example_3",
            id=cdktf.Token.as_string(
                cdktf.property_access(
                    cdktf.Fn.tolist(data_aws_outposts_outposts_example.ids), ["0"]))
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_aws_outposts_outpost_example.override_logical_id("example")
        aws_elasticache_subnet_group_example =
        aws.elasticache_subnet_group.ElasticacheSubnetGroup(self, "example_4",
        ...
        aws_elasticache_cluster_example =
        aws.elasticache_cluster.ElasticacheCluster(self, "example_5",
            cluster_id="cluster-example",
            engine="memcached",
            ...
            parameter_group_name="default.memcached1.4",
            port=11211,
            preferred_outpost_arn=cdktf.Token.as_string(data_aws_outposts_outpost_example.arn),
            subnet_group_name=cdktf.Token.as_string(aws_elasticache_subnet_group_example.name)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-fd91de436b86a43b0ccafc534c6162f922d9d5628df5f7d8991a6bb3eb4710ec -->
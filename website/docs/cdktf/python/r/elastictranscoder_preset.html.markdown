...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.elastictranscoder_preset.ElastictranscoderPreset(self, "bar",
            audio=ElastictranscoderPresetAudio(
                audio_packing_mode="SingleTrack",
                bit_rate=cdktf.Token.as_string(96),
                channels=cdktf.Token.as_string(2),
                codec="AAC",
                sample_rate=cdktf.Token.as_string(44100)
            ),
            ...
            thumbnails=ElastictranscoderPresetThumbnails(
                format="png",
                interval=cdktf.Token.as_string(120),
                max_height="auto",
                max_width="auto",
                padding_policy="Pad",
                sizing_policy="Fit"
            ...
            video=ElastictranscoderPresetVideo(
                ...
                fixed_gop="false",
                frame_rate="auto",
                keyframes_max_dist=cdktf.Token.as_string(240),
                max_frame_rate="60",
                max_height="auto",
                max_width="auto",
                padding_policy="Pad",
            ...
            video_codec_options={
                ...
                "Level": "2.2",
                "MaxReferenceFrames": cdktf.Token.as_string(3),
                "Profile": "main"
            },
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-3e42fcb3a6dc7d3bd5486dc97f8928c2846f270fbae362da0f230e762266fde7 -->
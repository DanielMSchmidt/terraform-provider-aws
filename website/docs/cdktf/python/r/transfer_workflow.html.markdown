...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.transfer_workflow.TransferWorkflow(self, "example",
            steps=[TransferWorkflowSteps(
                delete_step_details=TransferWorkflowStepsDeleteStepDetails(
                    name="example",
                    source_file_location=original_file
                ),
                type="DELETE"
            )
            ]
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-4b137d8d7e73b9adcf1bfab0b36634df79e6eb03a02359582e7a92ed94137d12 -->
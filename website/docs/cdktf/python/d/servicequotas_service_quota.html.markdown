...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.data_aws_servicequotas_service_quota.DataAwsServicequotasServiceQuota(self, "by_quota_code",
            quota_code="L-F678F1CE",
            service_code="vpc"
        )
        aws.data_aws_servicequotas_service_quota.DataAwsServicequotasServiceQuota(self, "by_quota_name",

...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        vpc_id = cdktf.TerraformVariable(self, "vpc_id")
        aws.data_aws_internet_gateway.DataAwsInternetGateway(self, "default",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b7f56116cb3aa5f129e5736a6ac748b6d3da30ffa24fdaef796aa003b41c1a78 -->
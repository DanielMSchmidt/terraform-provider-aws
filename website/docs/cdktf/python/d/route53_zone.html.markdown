...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_route53_zone_selected =
        aws.data_aws_route53_zone.DataAwsRoute53Zone(self, "selected",
            name="test.com.",
            private_zone=True
        )
        aws.route53_record.Route53Record(self, "www",
            name="www.${" + data_aws_route53_zone_selected.name + "}",
            records=["10.0.0.1"],
            ttl=cdktf.Token.as_number("300"),
            type="A",
            zone_id=cdktf.Token.as_string(data_aws_route53_zone_selected.zone_id)
        )
```

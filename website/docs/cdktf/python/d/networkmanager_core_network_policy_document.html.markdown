...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.data_aws_networkmanager_core_network_policy_document.DataAwsNetworkmanagerCoreNetworkPolicyDocument(self, "test",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-4d269b6781f970f932090c8270c29046a855d570c7b10fe0b1ff7fcb44cbb072 -->
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        aws.data_aws_cloudfront_origin_request_policy.DataAwsCloudfrontOriginRequestPolicy(self, "example",
            name="example-policy"
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        aws.data_aws_cloudfront_origin_request_policy.DataAwsCloudfrontOriginRequestPolicy(self, "ua_referer",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-25c6a283a7007ac4c1eeeb719db151403cb8d25b15dfa546967bfbbb2a63a347 -->
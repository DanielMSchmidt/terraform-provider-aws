...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_s3_object_bootstrap_script =
        aws.data_aws_s3_object.DataAwsS3Object(self, "bootstrap_script",
        ...
        aws.instance.Instance(self, "example",
            ...
            user_data=cdktf.Token.as_string(data_aws_s3_object_bootstrap_script.body)
        )
```

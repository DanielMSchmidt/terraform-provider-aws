...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_aws_s3_bucket_object_bootstrap_script =
        aws.data_aws_s3_bucket_object.DataAwsS3BucketObject(self, "bootstrap_script",
        ...
        aws.instance.Instance(self, "example",
            ...
            user_data=cdktf.Token.as_string(data_aws_s3_bucket_object_bootstrap_script.body)
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5740dc6877e63811f98bd32f57da6aa37d74cabdfed06c2ee64eb93ab3bf8a6e -->
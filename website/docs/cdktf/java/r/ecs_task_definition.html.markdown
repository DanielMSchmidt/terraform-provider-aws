...
import gen.providers.aws.ecsTaskDefinition.*;
public class MyConvertedCode extends TerraformStack {
    public MyConvertedCode(Construct scope, String name) {
        super(scope, name);
        new EcsTaskDefinition(this, "service", new EcsTaskDefinitionConfig()
                .containerDefinitions(Fn.jsonencode(List.of(Map.of(
                        "cpu", 10,
                        "essential", true,
                        "image", "service-first",
                        "memory", 512,
                        ...
                        "portMappings", List.of(Map.of(
                                ...
                                "hostPort", 443))))))
                .family("service")
                .placementConstraints(List.of(new EcsTaskDefinitionPlacementConstraints()
                        .expression("attribute:ecs.availability-zone in [us-west-2a, us-west-2b]")
                        .type("memberOf")
                        ))
                .volume(List.of(new EcsTaskDefinitionVolume()
...
public class MyConvertedCode extends TerraformStack {
    public MyConvertedCode(Construct scope, String name) {
        super(scope, name);
        new EcsTaskDefinition(this, "test", new EcsTaskDefinitionConfig()
                .containerDefinitions("[\n  {\n    \"cpu\": 10,\n    \"command\": [\"sleep\", \"10\"],\n    \"entryPoint\": [\"/\"],\n    \"environment\": [\n      {\"name\": \"VARNAME\", \"value\": \"VARVAL\"}\n    ],\n    \"essential\": true,\n    \"image\": \"jenkins\",\n    \"memory\": 128,\n    \"name\": \"jenkins\",\n    \"portMappings\": [\n      {\n        \"containerPort\": 80,\n        \"hostPort\": 8080\n      }\n    ],\n        \"resourceRequirements\":[\n            {\n                \"type\":\"InferenceAccelerator\",\n                \"value\":\"device_1\"\n            }\n        ]\n  }\n]\n")
                .family("test")
                .inferenceAccelerator(List.of(new EcsTaskDefinitionInferenceAccelerator()
                        .deviceName("device_1")

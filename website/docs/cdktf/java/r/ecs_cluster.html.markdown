...
import gen.providers.aws.ecsCluster.*;
public class MyConvertedCode extends TerraformStack {
    public MyConvertedCode(Construct scope, String name) {
        super(scope, name);
        new EcsCluster(this, "foo", new EcsClusterConfig()
                .name("white-hart")
                .setting(List.of(new EcsClusterSetting()
...
/*Provider bindings are generated by running cdktf get.
See https://cdk.tf/provider-generation for more details.*/
import gen.providers.aws.cloudwatchLogGroup.*;
import gen.providers.aws.kmsKey.*;
import gen.providers.aws.ecsCluster.*;
public class MyConvertedCode extends TerraformStack {
    public MyConvertedCode(Construct scope, String name) {
        super(scope, name);
        CloudwatchLogGroup awsCloudwatchLogGroupExample =
        new CloudwatchLogGroup(this, "example", new CloudwatchLogGroupConfig()
                .name("example")
                );
        KmsKey awsKmsKeyExample = new KmsKey(this, "example_1", new KmsKeyConfig()
                .deletionWindowInDays(7)
                .description("example")
                );
        /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
        awsKmsKeyExample.overrideLogicalId("example");
        new EcsCluster(this, "test", new EcsClusterConfig()
                .configuration(new EcsClusterConfiguration()
                        .executeCommandConfiguration(new EcsClusterConfigurationExecuteCommandConfiguration()
                                .kmsKeyId(Token.asString(awsKmsKeyExample.getArn()))
                                .logConfiguration(new EcsClusterConfigurationExecuteCommandConfigurationLogConfiguration()
                                        .cloudWatchEncryptionEnabled(true)
                                        .cloudWatchLogGroupName(Token.asString(awsCloudwatchLogGroupExample.getName()))
                                        )
                                .logging("OVERRIDE")
                                )
                        )

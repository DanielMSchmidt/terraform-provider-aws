...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const awsApigatewayv2RouteExample =
      new aws.apigatewayv2Route.Apigatewayv2Route(this, "example_1", {
        apiId: cdktf.Token.asString(awsApigatewayv2ApiExample.id),
        routeKey: "$default",
      });
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const awsApigatewayv2IntegrationExample =
      new aws.apigatewayv2Integration.Apigatewayv2Integration(
        this,
        "example_1",
        {
          apiId: cdktf.Token.asString(awsApigatewayv2ApiExample.id),
    ...
    const awsApigatewayv2RouteExample =
      new aws.apigatewayv2Route.Apigatewayv2Route(this, "example_2", {
        apiId: cdktf.Token.asString(awsApigatewayv2ApiExample.id),
